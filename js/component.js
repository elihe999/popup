...
window.onload = function(){
  ...
  let componentStyleHtml = 'div.alertATE-bg {' +
    'left:0;' +
    'top:0;' +
    'opacity:0.3;' +
    ...
    'height: 32px;' +
    'float: left;}' +
    'div.alertATE-content div.icon-error {' +
    ...
    'div.alertATE-content div.icon-info {' +
    ...
    'height: 45px;' +
    'float: left;}' +
    'div.loading label.alertATE-msg{' +
    'min-width: 100px;' +
    'max-width: 180px;' +
...
AlertClass.prototype.show = function (options) {
  ...
  if ('success' == this.icon) {
    iconContent = '<div class="alertATE-icon icon-success"></div>'
  } else if ('info' == this.icon) {
    iconContent = '<div class="alertATE-icon icon-info"></div>'
  } else {
    iconContent = '<div class="alertATE-icon icon-error"></div>'
  }

  let alert = document.createElement ('div');
  alert.innerHTML = ['<div class="alertATE-bg"></div>',
    '<div class="alertATE-wrapper">',
    '<div class="alertATE-content">',
    iconContent,
    '<label class="alertATE-msg">' + content + '</label>',
    '<span class="alertATE-closeBtn" onclick="AlertClass.btnClick()"></span>',
    '</div></div>'].join('');
...
ToastClass.prototype.show = function (options) {
  ...
  if (loading) {
    ...
    innerHTMLArr.push('<label class="alertATE-msg">' + text + '</label></div></div>');
  } else {
    innerHTMLArr.push('<div class="alertATE-icon icon-info"></div>');
    innerHTMLArr.push('<label class="alertATE-msg">' + text + '</label>');
    innerHTMLArr.push('<span class="alertATE-closeBtn"></span></div></div>');
  }
